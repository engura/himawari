 Gem::Specification.new do |s|
  ...
  s.description = 'Makes pretty, high-res backgrounds from the real-time photos of Earth by Himawari8, or is intended for similar personal usage. Please see the readme for more!'
  s.authors     = ["engura"]
